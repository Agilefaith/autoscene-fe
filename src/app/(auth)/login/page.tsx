        ...
        <div className="glass gradient-border rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex justify-end -mt-1">
              <a href="#" className="text-xs text-[#52525B] hover:text-[#00D4FF] transition-colors">
                Forgot password?
              </a>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-neon w-full py-3 rounded-xl text-sm font-semibold mt-1 disabled:opacity-60 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-center text-xs text-[#52525B] mt-6">
            ...
            <Link href="/signup" className="text-[#00D4FF] hover:text-white transition-colors font-medium">
              Sign up free
            </Link>
          </p>
        </div>
